 ...
 * 
 */
@WebServiceClient(name = "TicketServiceService", targetNamespace = "http://service.jamp/", wsdlLocation = "http://localhost:8080/JampWSWeb/TicketService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName TICKETSERVICESERVICE_QNAME = new QName("http://service.jamp/", "TicketServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/JampWSWeb/TicketService?wsdl");
    ...
    public TicketService getTicketServicePort() {
        return super.getPort(new QName("http://service.jamp/", "TicketServicePort"), TicketService.class);
    }
    ...
    public TicketService getTicketServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.jamp/", "TicketServicePort"), TicketService.class, features);
    }
